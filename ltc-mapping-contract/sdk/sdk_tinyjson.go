...
func tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp(in *jlexer.Lexer, out *EnvMap) {
...
func tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp(out *jwriter.Writer, in EnvMap) {
...
func (v EnvMap) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *EnvMap) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp(l, v)
}
func tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp1(in *jlexer.Lexer, out *Env) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "sender":
			tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp2(in, &out.Sender)
		case "msg.caller":
		...
		case "intents.caller":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v3 Intent
					tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp3(in, &v3)
		...
		case "intents.sender":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v4 Intent
					tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp3(in, &v4)
...
func tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp1(out *jwriter.Writer, in Env) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		out.RawString(prefix)
		tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp2(out, in.Sender)
	}
	{
	...
	}
	{
		...
		if in.CallerIntents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.CallerIntents {
				...
				tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp3(out, v6)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.SenderIntents == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v7, v8 := range in.SenderIntents {
				...
				tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp3(out, v8)
			}
			out.RawByte(']')
		}
	}
...
func (v Env) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp1(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *Env) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp1(l, v)
}
func tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp3(in *jlexer.Lexer, out *Intent) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp3(out *jwriter.Writer, in Intent) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp2(in *jlexer.Lexer, out *Sender) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp2(out *jwriter.Writer, in Sender) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp4(in *jlexer.Lexer, out *ContractCallOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "intents":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v17 Intent
					tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp3(in, &v17)
...
func tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp4(out *jwriter.Writer, in ContractCallOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Intents) != 0 {
		...
		out.RawString(prefix[1:])
		{
			...
			for v18, v19 := range in.Intents {
				...
				tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp3(out, v19)
			}
			out.RawByte(']')
		}
	}
...
func (v ContractCallOptions) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjson223cdf42EncodeLtcMappingContractSdkTinyjsonTmp4(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *ContractCallOptions) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjson223cdf42DecodeLtcMappingContractSdkTinyjsonTmp4(l, v)
}
