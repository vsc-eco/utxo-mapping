...
type AccountInfo struct {
	...
	Address    string // Caip10address (litecoin address they can recieve funds at)
}

// address should be Magi for internal transfers and LTC for unmaps
//
//tinyjson:json
...
type SystemSupply struct {
	...
	UserSupply   int64
	FeeSupply    int64
	BaseFeeRate  int64 // lits per byte
}
...
type MappingState struct {
	ContractState
	AddressRegistry map[string]*AddressMetadata // map of ltc addresses to the tags they were created with
}
...
const LtcAssetValue string = "LTC"
