...
const DefaultMaxUnmapPerBlock int64 = 100_000_000 // 1 BCH in satoshis
...
const OracleAddress = "did:vsc:oracle:bch"
...
// BCH has a single testnet (vs BTC's testnet3/testnet4 split).
const (
