...
// `execute` entrypoint that the BCH mapping contract calls during
// swap-tagged deposits. When the router fails or returns
// `amount_out == "0"`, bch-mapping-contract previously reverted the
...
import (
	...
	_ "bch-mapping-contract/sdk"
)

func main() {}

// Always returns {"amount_out":"0", "pool_state":{...}} regardless of
// input. Drives bch-mapping-contract into the BTC-C4 router-failure
