...
const DefaultMaxUnmapPerBlock int64 = 100_000_000 // 1 DOGE in dogetoshis
...
// Address Creation
const BackupCSVBlocks = 43200 // ~1 month at DOGE 1-min block time
...
// DOGE has a single testnet (vs BTC's testnet3/testnet4 split).
const (
