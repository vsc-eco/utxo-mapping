...
// `execute` entrypoint that the DOGE mapping contract calls during
// swap-tagged deposits. When the router fails or returns
// `amount_out == "0"`, doge-mapping-contract previously reverted the
...
import (
	...
	_ "doge-mapping-contract/sdk"
)

func main() {}

// Always returns {"amount_out":"0", "pool_state":{...}} regardless of
// input. Drives doge-mapping-contract into the BTC-C4 router-failure
