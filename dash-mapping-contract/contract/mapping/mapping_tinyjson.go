...
func tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp1(in *jlexer.Lexer, out *UtxoRegistry) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp1(out *jwriter.Writer, in UtxoRegistry) {
...
func tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp2(in *jlexer.Lexer, out *Utxo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp2(out *jwriter.Writer, in Utxo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp3(in *jlexer.Lexer, out *TxSpendsRegistry) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp3(out *jwriter.Writer, in TxSpendsRegistry) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp12(in *jlexer.Lexer, out *MapParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp12(out *jwriter.Writer, in MapParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp16(in *jlexer.Lexer, out *AllowanceParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp16(out *jwriter.Writer, in AllowanceParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v AllowanceParams) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp16(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *AllowanceParams) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp16(l, v)
}
func tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp17(in *jlexer.Lexer, out *ConfirmSpendParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp17(out *jwriter.Writer, in ConfirmSpendParams) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ConfirmSpendParams) MarshalTinyJSON(w *jwriter.Writer) {
	tinyjsonA043f2bcEncodeBtcMappingContractContractMappingTinyjsonTmp17(w, v)
}

// UnmarshalTinyJSON supports tinyjson.Unmarshaler interface
func (v *ConfirmSpendParams) UnmarshalTinyJSON(l *jlexer.Lexer) {
	tinyjsonA043f2bcDecodeBtcMappingContractContractMappingTinyjsonTmp17(l, v)
}
