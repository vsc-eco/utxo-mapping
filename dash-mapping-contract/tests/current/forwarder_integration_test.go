...
// TestCanonicalAttestationMessage_ByteParityWithValidator moved to
// tests/current/parity_cross_repo_test.go behind the `cross_repo`
// build tag — see that file + DEVELOPING.md for context.
// Round-3 audit OP-001.
